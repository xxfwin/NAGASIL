...
def argparser():
    ...
    parser.add_argument('--logdir', help='log directory', default='log/epidemicdecay/random')
    parser.add_argument('--savedir', help='save directory', default='trained_models/epidemicdecay/random')
    parser.add_argument('--resultdir', help='result directory', default='result/epidemicdecay/random')
...
def main(args):
    ...
    for iteration in trange(int(args.iteration)):
        ...
        while True:
            ...
            # act_choice_prob = non_recovered_prob * user_under_budget
            act_choice_prob = user_under_budget
            
            act = random.choices(action_space, weights = act_choice_prob, k = 1)[0]
            # print(act)
