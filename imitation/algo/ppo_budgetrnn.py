...
def rollout_generator(pi, env, discriminator, timesteps_per_batch, running_paths, stochastic, resultf, total_budget, user_cost):
    t = 0
    running_path_idx = 0
...
def learn(env, policy_fn, discriminator, *,
    ...
    rg = rollout_generator(pi, env, discriminator, timesteps_per_batch, running_paths, stochastic=True, resultf=resultf, total_budget=total_budget, user_cost=user_cost)
