...
def rollout_generator(pi, env, discriminator, timesteps_per_batch, running_paths, stochastic, resultf):
    t = 0
    running_path_idx = 0
    ...
    while True:
        ...
        # print("ac is :", ac)
        # print(type(ac))
        ob, rew_ER, new, info = env.step(int(ac))
...
def learn(env, policy_fn, discriminator, *,
        ...
        data_dump_path, mu, pq_replay_size, resultdir):
    ...
    rg = rollout_generator(pi, env, discriminator, timesteps_per_batch, running_paths, stochastic=True, resultf=resultf)
