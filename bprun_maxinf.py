...
def argparser():
    ...
    parser.add_argument('--logdir', help='log directory', default='log/epidemicdecay/maxinf')
    parser.add_argument('--savedir', help='save directory', default='trained_models/epidemicdecay/maxinf')
    parser.add_argument('--resultdir', help='result directory', default='result/epidemicdecay/maxinf')
...
def main(args):
    ...
    for iteration in trange(int(args.iteration)):
        ...
        while True:
            ...
            act_choice_prob = non_recovered_prob * num_followers * user_under_budget
